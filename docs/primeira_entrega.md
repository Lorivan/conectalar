...
| --- | --- | --- |
| Software avaliado | `Lorivan/conectalar` **[confirmar URL]** | Referência do código do ConectaLar que será avaliado. Não é a evidência de evolução do trabalho de Qualidade de Software deste semestre. |
